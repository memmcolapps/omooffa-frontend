      ...
      <MaxContainer>
        ...
        <div className="relative flex px-[10rem] flex-col pt-[10rem] sm:pt-[4rem]">
          <div className="self-center relative  z-[1] mt-[8rem] mb-[19rem] sm:mb-[14rem] w-[55rem] sm:w-[30rem]">
            <h1 className="font-[700] text-[5rem] leading-[5.5rem] sm:text-[3rem] text-center  text-[#FAFFFA]">
            ...
            <p className="text-center text-[#FAFFFA] max-w-[43rem] mx-auto text-[1.8rem] sm:text-[1.5rem] sm:font-[400] mt-[1rem]">
              ...
              home and abroad, while creating a more connected and prosperous
              community.
            </p>
            ...
            <div className="flex mt-[4rem] items-center justify-center gap-[1rem]">
              ...
              <Button className="font-[700] py-[1.8rem] hover:bg-[#002E20] hover:text-white px-[3.5rem] bg-[#B0FFAB] text-[#003525]">
                <Link className="" href={"/registration/tracking"}>
                  {" "}
                  Registration Status
                </Link>
              </Button>
