...
const Info = () => {
    ...
    return (
        <section className="bg-[#EFFFEE] border text-[#003525]">
            <MaxContainer>
                <div className="py-[9rem] px-[7rem] sm:px-[2.5rem]">
...
const Process = ({ process }) => {
    return (
        <div className="w-[60rem] sm:w-[100%] flex items-start gap-x-[1rem]">
