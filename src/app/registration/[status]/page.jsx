    ...
    return (
        <div className="pt-[8rem]">
            ...
            <div className="bg-white custom flex flex-col gap-y-[2rem] rounded-[1rem] mx-auto p-[2.5rem] w-[45rem] sm:w-auto">
                <FormGenerator fields={formFields} formData={formData} setFormData={setFormData} />
...
const FourthStep = (props) => {
    const { setStep, setFormData, formData, CreateUser, loading, data } = props
    const formFields = [
        {
            id: 'phoneNumber',
            label: 'Phone Number',
        ...
        <div className="pt-[8rem]">
            ...
            <div className="bg-white custom flex flex-col gap-y-[2rem] rounded-[1rem] mx-auto p-[2.5rem] w-[45rem] sm:w-auto">
                ...
                <div className="flex justify-between">
                    ...
                    <Button className='bg-[#002E20] px-[3.5rem] py-[2rem] hover:bg-[#B0FFAB] hover:text-[#002E20] rounded-[.5rem] text-[#C8FFC4] font-[700]' onClick={() => CreateUser({
                        ...formData,
                        numOfCurrentDependants: +formData.numOfCurrentDependants,
                        employmentStatus: formData.employmentStatus == 'True' ? true : false,
                    })}
