...
const Registration = () => {
  ...
  return (
    <section className="bg-[#EFFFEE] min-h-[100vh] sm:pb-[7rem] sm:w-full sm:pt-[12rem] sm:px-[2.5rem] sm:h-auto grid place-content-center">
      <div className="">
        <p className="text-center font-[700] text-[#07200B] mb-[2rem]">
          Choose your Category
        </p>
        <div className="max-w-[65rem] sm:w-full gap-[2rem] grid grid-cols-2 sm:grid-cols-1">
...
const Card = ({ category }) => {
  return (
    <div className="bg-[#002E20] flex flex-col px-[2rem] pt-[2.5rem] pb-[2rem]  w-[30rem] h-[17rem] rounded-[1rem]">
      ...
      <Button
        asChild
        className="mt-auto hover:bg-[#EFFFEE] w-full py-[2rem] bg-[#B0FFAB] text-[#002E20] font-[700] rounded-[.5rem]"
      >
